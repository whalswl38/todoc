...
public class UserRestController 
{
	...
	{
	    log.info("UserController userEmail : " + userEmail);
	...
	{
	    log.info("UserRestController login username : " + loginDto.getUsername());
	    log.info("UserRestController login password : " + loginDto.getPassword());
	    log.info("UserRestController login userType : " + loginDto.getUserType());
	    ...
	    log.info("UserRestController login authentication : " + authentication.getName());
	    ...
	    log.info("UserRestController accessToken : " + accessToken);
	    log.info("UserRestController refreshToken : " + refreshToken);

	    log.info("UserRestController loginDto.getUserType() : " + loginDto.getUserType());
	    if("MEDICAL".equals(loginDto.getUserType())) 
	    {
	        ...
	        if(clinic != null && clinic.getClinicStatus().equals("Y")) 
	        {
	        	try
	        	{
		        	log.info("UserRestController loginDto clinic ");
	        ...
	        if(pharm != null && pharm.getPharmacyStatus().equals("Y")) 
	        {
		       try
		       {
	        		log.info("UserRestController loginDto pharm ");
	    ...
	    else 
	    {
	        ...
	        log.info("UserRestController loginDto user ");
	...
	{		
		log.info("checkInstitution institutionNum : " + institutionNum);
