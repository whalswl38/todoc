...
public class KakaoPayService {
    ...
    public String kakaoPayReady() {
        ...
        params.add("approval_url", "http://localhost:8099/kakaoPaySuccess");
        params.add("cancel_url", "http://localhost:8099/kakaoPayCancel");
        params.add("fail_url", "http://localhost:8099/kakaoPaySuccessFail");
